  <div class="row w-100">
    ...
    <nav id="sidebarMenu" class="">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/teacher_assign_sub.php">
              <span data-feather="bar-chart-2"></span>
              <i class="fa fa-file-text-o mr-2" aria-hidden="true"></i> Teacher Subjects
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
                <a class="nav-link" href="../admin/event_index.php">
                  <span data-feather="layers"></span>
                  <i class="fa fa-clock-o mr-2" aria-hidden="true"></i> Event Calender
                </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/student-attendance-report.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Student Attendance Report
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/admin_result_entry.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Admin Result Interface
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/admin_view_results.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> View Result Summary
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/admin_result_summary.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Analyse College Result
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/admin_fees_assign.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Admin fees interface
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/admin_fees_payment.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Pay Fees Installment
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/admin_fees_report.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> View fees report
            </a>
          </li>
          <li class="nav-item">
