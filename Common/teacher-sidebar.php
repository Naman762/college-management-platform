			...
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						...
						<i class="fa fa-address-book mr-2" aria-hidden="true"></i> Teacher Course Detail
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/weekly_schedule.php">
						<span data-feather="users"></span>
						<i class="fa fa-check-circle mr-2" aria-hidden="true"></i> Weekly Schedule
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/view_schedule.php">
						<span data-feather="users"></span>
						<i class="fa fa-check-circle mr-2" aria-hidden="true"></i> View Schedule
						</a>
					</li>
					<li class="nav-item">
