...
<?php 
 	...
 	if (isset($_POST['btn_save'])) {
 		...
 		$query="insert into time_table(course_code,semester,timing_from,timing_to,day,subject_code,teacher_name)values('$course_code','$semester','$timing_from','$timing_to','$day','$subject_code','$teacher_name')";
...
<?php 
 	...
 	if (isset($_POST['btn_update'])) {
		...
		$teacher_name=$_POST["teacher_name"];
 		...
 		$query1="update time_table set course_code='$course_code',semester='$semester',timing_from='$timing_from',timing_to='$timing_to',day='$day',subject_code='$subject_code',teacher_name='$teacher_name' where subject_code='$subject_code'";
													...
													<div class="modal-body">
														<form action="time-table.php" method="post">
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="formp">
																		<label for="exampleInputPassword1">Enter Faculty Name</label>
																		<select class="browser-default custom-select" name="teacher_name" required="">
							...
							<div class="row">
								<div class="col-md-12">
									<table class="w-100 table-elements table-three-tr" cellpadding="3">
										...
										<?php  
											$query="select id,course_code,TIME_FORMAT(timing_from,'%h:%i %p') as timing_from,TIME_FORMAT(timing_to,'%h:%i %p') as timing_to,semester,day_name,day_id,day,subject_code,teacher_name from time_table tt inner join weekdays wd on tt.day=wd.day_id";
											$run=mysqli_query($con,$query);
											while($row=mysqli_fetch_array($run)) {
												echo "<tr>";
												echo "<td>".$row["id"]."</td>";
