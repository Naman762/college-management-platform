...
?>
<!-- --------------------------------Delete Teacher alloted course------------------------------------- -->
<?php 
	if (isset($_GET['teacher_courses_id'])) {
		$teacher_courses_id=$_GET['teacher_courses_id'];
		$query3="delete from teacher_courses where teacher_courses_id='$teacher_courses_id'";
		$run3=mysqli_query($con,$query3);
		if ($run3) 
		{
			header('Location: teacher_assign_sub.php');
		}
		else{
			echo "Record not deleted";
		}
