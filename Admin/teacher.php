...
<?php  
	if (isset($_POST['btn_save2'])) {
		...
		$query3="insert into teacher_courses(course_code,semester,teacher_id,teacher_name,subject_code,assign_date,total_classes)values('$course_code','$semester','$teacher_id','$teacher_name','$subject_code','$date','$total_classes')";
									...
									<div class="modal-body">
										<form action="teacher.php" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Applying Course</label>
										<!--
											changes here 
										-->				<select class="browser-default custom-select" name="course_code" required="">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label for="exampleInputEmail1">Last Experience From: </label>
														<input type="date" name="matric_complition_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Last Experience From:</label>
														<input type="date" name="matric_awarded_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Last Experience Certificate:</label>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">12th cartificate Date:</label>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label for="exampleInputEmail1">Under-Graduation Complition Date: </label>
														<input type="date" name="ba_complition_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Under-Graduation Date:</label>
														<input type="date" name="ba_awarded_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Upload Under-Graduation Certificate:</label>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label for="exampleInputEmail1">Post-Graduation Complition Date: </label>
														<input type="date" name="ma_complition_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Post-Graduation Certificate Date:</label>
														<input type="date" name="ma_awarded_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Upload Post-Graduation Certificate:</label>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select class="browser-default custom-select" id="teacher_id" name="teacher_id" required="">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input class="browser-default custom-select" type="text" id="teacher_name" name="teacher_name" >
																</div>
															</div>
														</div>
														<div class="row">
...
$(document).ready(function(){
  $('#teacher_id').change(function(){
    ...
    if(teacherId){
      $.ajax({
        url: "teacher_idtoname.php",  // PHP file to fetch teacher name
        method: "POST",
